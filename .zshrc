...
retVal=$?
if [[ $retVal -eq 0 ]]; then
  alias savepower="sudo sh -c \"modprobe acpi_call && echo '\_SB.PCI0.LPC0.EC0.VPC0.DYTC 0x0013B001' > /proc/acpi/call && echo '\_SB.PCI0.LPC0.EC0.VPC0.SBMC 0x03' > /proc/acpi/call\""
  alias performance="sudo sh -c \"modprobe acpi_call && echo '\_SB.PCI0.LPC0.EC0.VPC0.DYTC 0x0012B001' > /proc/acpi/call && echo '\_SB.PCI0.LPC0.EC0.VPC0.SBMC 0x05' > /proc/acpi/call\""
  alias rapidchargeon="sudo sh -c \"modprobe acpi_call && echo '\_SB.PCI0.LPC0.EC0.VPC0.SBMC 0x07' > /proc/acpi/call\""
  alias rapidchargeoff="sudo sh -c \"modprobe acpi_call && echo '\_SB.PCI0.LPC0.EC0.VPC0.SBMC 0x08' > /proc/acpi/call\""
fi
...
if (( ${+commands[exa]} )); then
  ...
  alias ls='exa --group-directories-first --group --icons --bytes --git --all'
